...
<div class=" register" >
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <h3>Welcome to Concert Reservation</h3>
                    ...
                    <div class="col-md-9 register-right">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-12">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                        	<label>Order date</label><span id="P_date1"></span>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                        	<label>Order Time</label><span id="D_date1"></span>
                                               ...
                                               <?php $Show1=Serv_Type();
									                $count='0';
									                 while ($row=$Show1->fetch_object()) {
									                   $count++;
									                ?>
									              <option value="<?php echo $row->Concert ?>"><?php echo $row->Concert ?></option>
									                  <?php };?>
...
function submit(){
  ...
  var Firstseat= $("#Firstseat:checked").val();
  var Secondseat= $("#Secondseat:checked").val();
  ...
  if(P_date==''){
    document.getElementById("P_date1").innerHTML = " (Please enter Order Date)";
     exit();
  }
  if(D_date==''){
    document.getElementById("D_date1").innerHTML = " (Please enter Order Time)";
     exit();
  }
  if(Address==''){
  ...
  if(Total_item==''){
    ...
    // alert(Secondseat);
            $.ajax({
              ...
              data:'name='+name+'&phone='+phone+'&P_date='+P_date+'&D_date='+D_date+'&Address='+Address+'&item='+item+'&Type='+Type+'&Firstseat='+Firstseat+'&Secondseat='+Secondseat+'&Total_item='+Total_item,
              success:function(html)
              {
               $('#css').html(html);
